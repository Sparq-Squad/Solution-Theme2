...
<div className="flex items-center justify-between mb-8">
  {/* Title & Subtitle */}
  <div>
    <h1 className="text-2xl font-bold text-yellow-300 mb-2">Analytics Report</h1>
...
>
  <option className="bg-[#1a1a1a] text-amber-300" value="last-7-days">Last 7 days</option>
  <option className="bg-[#1a1a1a] text-amber-300" value="last-30-days">Last 30 days</option>
  <option className="bg-[#1a1a1a] text-amber-300" value="last-90-days">Last 90 days</option>
  <option className="bg-[#1a1a1a] text-amber-300" value="last-year">Last year</option>
  <option className="bg-[#1a1a1a] text-amber-300" value="custom">Custom range</option>
</select>
      ...
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-yellow-300">{item.value}</p>
            <div className="flex items-center mt-1">
              <span className="mr-1 text-green-400">↑</span>
              <span className="text-sm text-green-400 font-medium">{item.change}</span>
            </div>
          </div>
        </div>
      </div>
...
<div className="bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg border border-gray-700 shadow transition duration-300 hover:border-yellow-500">
  <div className="px-6 py-4 border-b border-gray-700">
    <h2 className="text-lg font-semibold text-yellow-300">Revenue & Orders Trend</h2>
  </div>
  <div className="p-6">
    <div className="h-64">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={salesData}>
          ...
          <Tooltip
            contentStyle={{ backgroundColor: '#1e2433', borderColor: '#3f3f46' }}
...
<div className="bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg border border-gray-700 shadow transition duration-300 hover:border-yellow-500">
  <div className="px-6 py-4 border-b border-gray-700">
    <h2 className="text-lg font-semibold text-yellow-300">Report Generation Status</h2>
  </div>
  <div className="p-6">
  ...
  <>
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg border border-gray-700 shadow hover:border-yellow-500 transition">
        <div className="px-6 py-4 border-b border-gray-700">
          <h2 className="text-lg font-semibold text-yellow-300">Top Products by Revenue</h2>
        </div>
        <div className="p-6">
          <div className="space-y-4">
            {productPerformance.map((product, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg hover:border-yellow-400 border border-transparent transition">
                <div>
                  <p className="font-medium text-yellow-200">{product.name}</p>
                  <p className="text-sm text-gray-400">{product.units} units sold</p>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-yellow-300">${product.sales.toLocaleString()}</p>
      ...
      <div className="bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg border border-gray-700 shadow hover:border-yellow-500 transition">
        <div className="px-6 py-4 border-b border-gray-700">
          <h2 className="text-lg font-semibold text-yellow-300">Monthly Sales Performance</h2>
        </div>
        <div className="p-6">
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={salesData}>
                ...
                <YAxis stroke="#ccc" />
                <Tooltip
                  contentStyle={{ backgroundColor: '#1f1f2b', borderColor: '#666', color: '#fff' }}
    ...
    <div className="bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg border border-gray-700 shadow hover:border-yellow-500 transition mt-8">
      <div className="px-6 py-4 border-b border-gray-700">
        <h2 className="text-lg font-semibold text-yellow-300">Sales Performance Summary</h2>
      </div>
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 rounded-lg bg-[#22302e]">
            <h3 className="text-lg font-semibold text-green-400 mb-2">Best Performing Month</h3>
            <p className="text-2xl font-bold text-green-300">June 2024</p>
            <p className="text-sm text-green-200">$15,234 revenue | 178 orders</p>
          </div>
          <div className="text-center p-4 rounded-lg bg-[#1e2d3d]">
            <h3 className="text-lg font-semibold text-blue-400 mb-2">Average Growth Rate</h3>
            <p className="text-2xl font-bold text-blue-300">+12.5%</p>
            <p className="text-sm text-blue-200">Month-over-month growth</p>
          </div>
          <div className="text-center p-4 rounded-lg bg-[#2b223b]">
            <h3 className="text-lg font-semibold text-purple-400 mb-2">Top Product Category</h3>
            <p className="text-2xl font-bold text-purple-300">Audio</p>
            <p className="text-sm text-purple-200">67% of total revenue</p>
          </div>
        </div>
      </div>
    </div>
...
{activeTab === 'marketing' && (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div className="bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg border border-gray-700 shadow hover:border-yellow-500 transition">
      <div className="px-6 py-4 border-b border-gray-700">
        <h2 className="text-lg font-semibold text-yellow-300">Marketing Channel ROI</h2>
      </div>
      <div className="p-6">
        <div className="space-y-4">
          {marketingROI.map((channel, index) => (
            ...
            >
              <div>
                <p className="font-medium text-yellow-200">{channel.channel}</p>
                <p className="text-sm text-gray-400">Spend: ${channel.spend}</p>
              </div>
              <div className="text-right">
                <p className="font-semibold text-yellow-300">{channel.roi}x ROI</p>
                <p className="text-sm text-green-400">${channel.revenue} revenue</p>
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg border border-gray-700 shadow hover:border-yellow-500 transition">
      <div className="px-6 py-4 border-b border-gray-700">
        <h2 className="text-lg font-semibold text-yellow-300">Channel Performance Comparison</h2>
      </div>
      <div className="p-6">
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
...
{activeTab === 'competition' && (
  <div className="bg-gradient-to-b from-[#0b0c10] via-[#111217] to-[#1a1a1a] rounded-lg border border-gray-700 shadow hover:border-yellow-500 transition">
    <div className="px-6 py-4 border-b border-gray-700">
      <h2 className="text-lg font-semibold text-yellow-300">Competitive Landscape Analysis</h2>
    </div>
    <div className="p-6">
      <div className="space-y-4">
        {competitorAnalysis.map((competitor, index) => (
          ...
          >
            <div>
              <h3 className="font-medium text-yellow-200">{competitor.competitor}</h3>
              <p className="text-sm text-gray-400">Market Position: #{index + 1}</p>
            </div>
            <div className="grid grid-cols-3 gap-8 text-center">
              <div>
                <p className="text-sm text-gray-400">Market Share</p>
                <p className="font-semibold text-yellow-300">{competitor.marketShare}%</p>
              </div>
              <div>
                <p className="text-sm text-gray-400">Price Index</p>
                <p className="font-semibold text-yellow-300">{competitor.priceIndex}</p>
              </div>
              <div>
                <p className="text-sm text-gray-400">Brand Strength</p>
                <p className="font-semibold text-yellow-300">{competitor.brandStrength}/100</p>
              </div>
            </div>
          </div>
        ))}
...
{activeTab === 'insights' && (
  <div className="space-y-6">
    ...
    <div className="bg-[#172215] border border-green-800 rounded-lg hover:border-yellow-500 transition">
      <div className="p-6">
        <h3 className="font-semibold text-green-400 mb-2">Key Opportunities</h3>
    ...
    <div className="bg-[#15202b] border border-blue-800 rounded-lg hover:border-yellow-500 transition">
      <div className="p-6">
        <h3 className="font-semibold text-blue-400 mb-2">Strategic Recommendations</h3>
    ...
    <div className="bg-[#261e15] border border-orange-800 rounded-lg hover:border-yellow-500 transition">
      <div className="p-6">
        <h3 className="font-semibold text-orange-400 mb-2">Risk Factors</h3>
